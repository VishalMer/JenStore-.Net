                ...
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 menu-mobile">
                    <div class=" collapse navbar-collapse" id="myNavbar">
                        ...
                        <ul class="nav navbar-nav menu-main">
                            ...
                            <li><a href="shopping-cart.aspx" class="active">Shopping Cart</a><figure id="wedding-1" class=" hidden-sm hidden-md hidden-xs">
                                </figure>
                            </li>
        ...
        <div class="banner">
            <div class="container">
                ...
                <div class="title-banner">
                    <h1>Shopping Cart</h1>
                    <p>
                        <a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i>Shopping Cart</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 space-30">
                                    <div class="item">
                                        ...
                                        <p class="box">
                                            <span class="float-left">SHIPPING</span><span class="float-right">$52.00</span></p>
                                        <p class="box space-30">
                                            <span class="float-left"><b>SUBTOTAL</b></span><span class="float-right"><b class="color-brand">$5,200.00</b></span></p>
