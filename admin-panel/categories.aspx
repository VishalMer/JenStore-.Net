<%@ Page Title="" Language="C#" MasterPageFile="~/admin-panel/categories.Master" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="JenStore.admin_panel.categories1" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <html>
    <head>
        <title>Category Management - JenStore Admin</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <nav class="admin-nav">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <a href="index.aspx" class="nav-link"><i class="fas fa-tachometer-alt"></i>Dashboard </a><a href="products.aspx" class="nav-link"><i class="fas fa-box"></i>Products </a><a href="categories.aspx" class="nav-link active"><i class="fas fa-tags"></i>Categories </a><a href="orders.aspx" class="nav-link"><i class="fas fa-shopping-cart"></i>Orders </a><a href="customers.aspx" class="nav-link"><i class="fas fa-users"></i>Customers </a><a href="analytics.aspx" class="nav-link"><i class="fas fa-chart-bar"></i>Analytics </a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="categories-container">
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                Beautiful rose arrangements in various colors and styles
                            </div>
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                Mixed flower arrangements perfect for special occasions
                            </div>
                            <div class="category-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                Fresh tulips in vibrant spring colors
                            </div>
                            <div class="category-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                Flowers and arrangements for specific seasons
                            </div>
                            <div class="category-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                High-end luxury flower arrangements
                            </div>
                            <div class="category-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
                    ...
                    <div class="category-item">
                        <div class="category-info">
                            ...
                            <div class="category-description">
                                Natural wildflower collections and arrangements
                            </div>
                            <div class="category-stats">
                                <div class="stat-item">
                                    <div class="stat-number">
