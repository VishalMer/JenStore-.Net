<%@ Page Title="" Language="C#" MasterPageFile="~/admin-panel/analytics.Master" AutoEventWireup="true" CodeBehind="analytics.aspx.cs" Inherits="JenStore.admin_panel.analytics" %>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="../home.html" class="btn btn-store btn-sm ml-2"><i class="fas fa-home"></i>Back to Store </a><a href="../login_register.html" class="btn btn-logout btn-sm ml-2"><i class="fas fa-sign-out-alt"></i>Logout </a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="analytics.aspx" class="nav-link active"><i class="fas fa-chart-bar"></i>Analytics </a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="metric-card">
                            ...
                            <div class="value">
                                <asp:Label ID="lblTotalRevenue" runat="server">$0</asp:Label></div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="metric-card">
                            ...
                            <div class="value">
                                <asp:Label ID="lblTotalOrders" runat="server">0</asp:Label></div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="metric-card">
                            ...
                            <div class="value">
                                <asp:Label ID="lblTotalCustomers" runat="server">0</asp:Label></div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="metric-card">
                            ...
                            <div class="value">
                                <asp:Label ID="lblAvgOrderValue" runat="server">$0.00</asp:Label></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="chart-container">
                            <h4><i class="fas fa-chart-area"></i>Revenue Trend (Last 30 Days)</h4>
                    ...
                    <div class="col-md-4">
                        <div class="chart-container">
                            ...
                            <ul class="kpi-list">
                                <%-- This list is now a dynamic Repeater --%>
                                <asp:Repeater ID="rptFunnel" runat="server">
                                    <ItemTemplate>
                                        <li><span><%# Eval("KpiName") %></span><strong><%# Eval("KpiValue") %></strong></li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
                        </div>
