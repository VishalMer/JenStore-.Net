                    ...
                    <div class="banner">
                        <div class="container">
                            ...
                            <div class="title-banner">
                                ...
                                <p>
                                    <a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i>User Dashboard</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="user-info-card">
                                    ...
                                    <div class="user-details">
                                        ...
                                        <div class="user-detail-item">
                                            <span class="detail-label">Username:</span> <span class="detail-value">johndoe123</span>
                                        </div>
                                        <div class="user-detail-item">
                                            <span class="detail-label">Email:</span> <span class="detail-value">john.doe@example.com</span>
                                        </div>
                                        <div class="user-detail-item">
                                ...
                                <div class="shortcuts-grid">
                                    <div class="shortcut-card" onclick="window.location.href='shopping-cart.aspx'">
                                        ...
                                        <div class="shortcut-desc">
                                            View and manage your cart items</div>
                                    </div>
                                    ...
                                    <div class="shortcut-card" onclick="window.location.href='Shopping.aspx'">
                                        ...
                                        <div class="shortcut-title">
                                            Shop Now</div>
                                        <div class="shortcut-desc">
                                            Browse our latest products</div>
                                    </div>
