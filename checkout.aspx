                    ...
                    <div class=" collapse navbar-collapse" id="myNavbar">
                       <%-- <form class="hidden-lg hidden-md form-group form-search-mobile">
                        ...
                        <ul class="nav navbar-nav menu-main">
                            ...
                            <li><a href="checkout.aspx" class="active">Checkout</a><figure id="wedding-1" class=" hidden-sm hidden-md hidden-xs">
                                </figure>
                            </li>
        ...
        <div class="banner">
            <div class="container">
                ...
                <div class="title-banner">
                    <h1>Checkout</h1>
                    <p>
                        <a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i>Checkout</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group col-md-6">
                                    ...
                                    First Name <span class="color">*</span></label>
                                    <input type="text" placeholder="Enter your first name..." id="inputfname" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputlname" class=" control-label">
                                    Last Name <span class="color">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    Adress<span class="color">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    Town/City<span class="color">*</span></label>
                                    <input type="text" placeholder="Enter your Town..." id="inputcountry" class="form-control space-20">
                                </div>
                                <div>
                                    <div class="form-group col-md-6">
                                        <label for="inputfState" class=" control-label">
                                        COUNTY <span class="color">*</span></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        POSTCODE <span class="color">*</span></label>
                                ...
                                <input type="checkbox" name="check2" id="check-2"><span class="checkmark"></span> Ship to a different address?</label>
                            </form>
                        </div>
                        <!-- End col-md-8 -->
                            ...
                            <div class="box">
                                ...
                                <div class="info-order">
                                    <div class="product-name">
                                        <ul>
                                            <li class="head"><span class="name">PRODUCTS NAME</span> <span class="qty"><b>QTY</b></span> <span class="total"><b>SUB TOTAL</b></span> </li>
                                            <li><span class="name">Modern Chair</span> <span class="qty">01</span> <span class="total">$520.00</span> </li>
                                            <li><span class="name">Toldbod Lamp</span> <span class="qty">02</span> <span class="total">$190.00</span> </li>
                                            <li><span class="name">Getama Sofa</span> <span class="qty">03</span> <span class="total">$270.00</span> </li>
                                        </ul>
                                    </div>
                                    <!-- End product-name -->
                                    <ul class="product-order">
                                        <li><span class="left">CART SUBTOTAL</span> <span class="right">$980.00</span> </li>
                                        <li><span class="left">SHIPPING & HANDLING</span> <span class="right">Free Shipping</span> </li>
                                        <li><span class="left">ORDER TOTAL</span> <span class="right brand">$980.00</span> </li>
                                    </ul>
                                </div>
                                <!-- End info-order -->
                                <div class="payment-order box float-left">
                                    ...
                                    <ul class="tabs">
                                        ...
                                        <li><i class="icon"></i>
                                            ...
                                            <a href="#" title="Temr & conditions">Temr & conditions</a> </li>
                                    </ul>
                                </div>
