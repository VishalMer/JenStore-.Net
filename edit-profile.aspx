...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                ...
                <body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-10 col-xs-9">
                                <ul class="nav navbar-nav navbar-right icon-menu">
                                    ...
                                    <li class="dropdown cart-menu"><a href="shopping-cart.aspx">
                    ...
                    <div class="container edit-profile-container" style="width: 80%; margin-top: -3em;">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="edit-profile-card">
                                    <div class="edit-profile-header" style="margin-top: -2em;">
                                    ...
                                    <form id="editProfileForm" class="form-horizontal" role="form">
                                            ...
                                            <div class="col-xs-6 col-sm-6 field-col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="username" name="username" value="johndoe123" placeholder="Enter your username" autocomplete="username" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 field-col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" value="john.doe@example.com" placeholder="you@example.com" autocomplete="email" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-6 col-sm-6 field-col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" class="form-control" id="currentPassword" name="currentPassword" placeholder="Enter your current password" autocomplete="current-password" required> <span class="input-group-addon" id="togglePassword" aria-label="Show password"><i class="fas fa-eye"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row action-row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="button" class="btn-cancel btn btn-default" onclick="window.location.href='user-dashboard.aspx'">
