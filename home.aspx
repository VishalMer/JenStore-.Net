            ...
            <nav class="hidden-xs">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right language">
                        <li class="dropdown eng-language"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Eng</a><figure id="language-figure">
                            </figure>
                ...
                <div class="row">
                    ...
                    <ul class="nav navbar-nav navbar-right icon-menu col-lg-4 col-md-4 col-sm-5 col-xs-5">
                        ...
                        <li id="input-search" class="hidden-sm hidden-xs"><a href="#">
                            <img src="img/Search.png" alt="img-holiwood"></a> </li>
                    </ul>
                </div>
            </div>
        </header>
...
<!-- Wrapper for slides -->
            <div class="carousel-inner">
                ...
                <div class="item slide-2">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p>
                            It is a long established fact that a reader will be distracted by the redable content of a page when looking at its latout</p>
                        <a href="#">Shop now</a>
                    </div>
                </div>
        ...
        <div class="who" id="showcase">
            <div class="gallery clearfix">
                <figure>
                    ...
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has<br class="hidden-md hidden-sm hidden-xs">been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type<br class="hidden-md hidden-sm hidden-xs">and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into<br class="hidden-md hidden-sm hidden-xs">electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of
                        <br class="hidden-md hidden-sm hidden-xs">Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing
                        <br class="hidden-md hidden-sm hidden-xs">software like Aldus PageMaker including versions of Lorem Ipsum
                    </p>
                    <div class="media">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 product-collection">
                                <div class="product-image-collec">
                                    ...
                                    <div class="product-icon-collec">
                                        <a href="#" data-toggle="modal" data-target="#myModal"><i class="far fa-eye"></i></a><a href="#"><i class="fas fa-shopping-basket"></i></a><a href="#"><i class="far fa-heart"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 product-collection">
                                ...
                                <div class="product-title-collec">
                                    ...
                                    <div class="prince">
                                        $100.9<s class="strike">$150.9</s></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 product-wedding">
                                <div class="product-image-wedding">
                                    ...
                                    <div class="product-icon-wedding">
                                        <a href="#"><i class="far fa-eye"></i></a><a href="#"><i class="fas fa-shopping-basket"></i></a><a href="#"><i class="far fa-heart"></i></a>
                                    </div>
                                </div>
                                <div class="product-title-wedding">
                                    ...
                                    <div class="prince">
                                        $300.2<s class="strike">$250.9</s></div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 product-wedding">
                                <div class="product-image-wedding">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 product-holiday">
                                    ...
                                    <div class="product-title-holiday">
                                        ...
                                        <div class="prince">
                                            $209.2<s class="strike">$180.9</s></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="count">
            ...
            <div class="title-count">
                <h1>Sale up to 40%</h1>
                <p>
                    It is a long established facr that a reader will be distracted by the<br>readable content of a page when looking at its layout</p>
                <div id="countdown">
                    <div id='tiles'>
                    </div>
                    <ul class="labels">
        ...
        <div class="brand container">
            <div class="row">
                <div class="brand-1 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
                <div class="brand-2 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
                <div class="brand-3 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
                <div class="brand-4 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
                <div class="brand-5 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
                <div class="brand-6 col-lg-2 col-md-2 col-sm-2 col-xs-4">
                </div>
            </div>
        </div>
        <div class="container blog">
            <h1>Latest Blogs</h1>
            <p>
                - Lorem Ipsum is<span class="hidden-xs"> simply dummy</span> text of the printing -</p>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 product-blog">
                    <a href="#">
                    <img src="img/440x360.png" class="img-responsive" title="img-blog" alt="img-holiwood"></a>
                    <div class="time-blog">
                        <span class="time"><i class="far fa-calendar-alt"></i><span>May, 12 2018</span></span> <span class="time"><i class="far fa-edit"></i><span>Pixel-Creative</span></span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 info-footer">
                        ...
                        <div class="social-text">
                            <span id="text-connect">CONNECT WITH US:</span> <span class="social"><a href="#" id="instar"></a><a href="#" id="fb"></a><a href="#" id="tw"></a><a href="#" id="sky"></a></span>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 new-letter">
                        <div class="form-new">
                            <h1>Newsletter</h1>
                            <p>
                                Sign up for our mailing list to get lastest updates and offers</p>
                                                ...
                                                <div class="tab-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div id="img-pill-1" class="tab-pane fade in active">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 detail">
                                                            ...
                                                            <div class="prince">
                                                                <span>$250.9</span><s class="strike">$300.02</s></div>
                                                            ...
                                                            <div class="select-custom">
                                                                <select>
                                                                    ...
                                                                    <option>L</option>
                                                                    <option>XL</option>
                                                                </select> <a href="#"><span class="color-1"></span></a><a href="#"><span class="color-2"></span></a><a href="#"><span class="color-3"></span></a><a href="#"><span class="color-4"></span></a>
                                                                <p class="require">
                                                                    Required Fields <span>*</span></p>
                                                                <div class="Quality">
                                                    ...
                                                    <div id="img-pill-2" class="tab-pane fade">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 detail">
                                                            ...
                                                            <div class="prince">
                                                                <span>$300.02</span><s class="strike">$250.9</s></div>
                                                            <figure class="fi-option">
                                                                <p class="option">
                                                                    Option</p>
                                                            </figure>
